...
@include('partials.field', ['name' => 'fecha_aplicacion', 'label' => 'Fecha de aplicación', 'type' => 'date', 'required' => true, 'value' => $registro?->fecha_aplicacion?->format('Y-m-d') ?? today()->toDateString()])
